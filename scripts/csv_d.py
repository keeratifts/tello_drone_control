...
goal = dict()
for i in range(0, N):
    goal[i] = open('/home/robolab/Desktop/nicson/droneformationexperiment/kk/Coverage control/Trajectory_Log/goal_'+str(i+1)+'.csv','r')
...
if __name__ == '__main__':
    try:
        ...
        d[1] = ('192.168.11.6', 8889)
        d[2] = ('192.168.11.37', 8889)
